...
<td style="padding:8px;border-top:1px solid #eee;">${s.partNumber || "-"}</td>
<td style="padding:8px;border-top:1px solid #eee;">${s.patternNumb || "-"}</td>
<td style="padding:8px;border-top:1px solid #eee;">${s.quantite || 0}</td>
